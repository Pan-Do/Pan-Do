...
class tkLogin:
    ...
    def __init__(self, window, listener):
        ...
        self.usernameEntry = Entry(self.loginFrame, font = self.font)
        self.usernameLabel = Label(self.loginFrame, text = "Username ", font = self.font)
        self.passwordEntry = Entry(self.loginFrame, show = "•", font = self.font)
        self.passwordLabel = Label(self.loginFrame, text = "Password ", font = self.font)

        self.loginButton = Button(self.loginFrame, text = "Login", font = self.font, command = self.login)

        self.forgotPasswordLabel = Label(self.loginFrame, text = "Forgot Password?", font = self.font)
        self.signUpButton = Button(self.loginFrame, text = "Sign Up", font = self.font, command = lambda: self.displaySignUpPage())
        ...
        self.registerButton = Button(self.loginFrame, text = "Register Account", font = self.font, command =lambda: self.register(self.fullNameEntry.get(),
                                                                                                         self.emailEntry.get(),
                                                                                                         self.signUpPasswordEntry.get()))
        self.cancelRegisterButton = Button(self.loginFrame, text = "Cancel", font = self.font, command = lambda: self.backToLoginPage())
